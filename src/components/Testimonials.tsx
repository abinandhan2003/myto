...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      id: 2,
      name: "Mark Peterson",
      role: "Owner, Peterson's Coffee Shop",
  ...
  return (
    <section id="testimonials" className="section bg-page-background">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              key={testimonial.id}
              className="bg-white rounded-xl p-6 shadow-sm opacity-0 animate-fade-up card-hover"
